...
export default function NewProductPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      handleApiError(err, t('products.createFailed'));
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold text-slate-900 tracking-tight">{t('products.newProduct')}</h1>
      </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card title={t('products.pricing')}>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <Input id="price" label={t('products.price')} type="number" step="0.01" required={!form.hasVariants} value={form.price} onChange={(e) => updateField('price', e.target.value)} />
          ...
          <div className="space-y-8">
            <Card title={t('products.organization')}>
              <div className="space-y-4">
                ...
                />
                <Input id="tags" label={t('products.tagsSeparated')} value={form.tags} onChange={(e) => updateField('tags', e.target.value)} placeholder={t('products.tagPlaceholder')} />
                <Select
                  id="visibility"
            ...
            <Button type="submit" loading={saving} className="w-full">
              <Save className="h-4 w-4 mr-1" /> {t('products.createProduct')}
            </Button>
          </div>
        </div>
      </form>
